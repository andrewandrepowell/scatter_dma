...
set Library     "hls"
set IPName      "pwm_prepare"
set Version     "1.0"
set DisplayName "Pwm_prepare"
set Revision    "1609181433"
...
set Interfaces {
    s_axi_control_axil {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_control_axil"
        param_prefix "C_S_AXI_CONTROL_AXIL"
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x10 shift_val W 0x0 "Data signal of shift_val" {{0 32 shift_val W 0 "Bit 31 to 0 Data signal of shift_val"}}} {0x18 sum_val W 0x0 "Data signal of sum_val" {{0 32 sum_val W 0 "Bit 31 to 0 Data signal of sum_val"}}} {0x20 enable_flag W 0x0 "Data signal of enable_flag" {{0 1 enable_flag W 0 "Bit 0 to 0 Data signal of enable_flag"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control_axil input_axis output_axis"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
set enable_xo_gen 0
set kernel_files {/opt/Xilinx/Projects/scatter_dma/pwm_prepare/solution1/.tcls/pwm_prepare.cpp}
if {$enable_xo_gen} {
