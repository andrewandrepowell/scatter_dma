...
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports {user_in_tri_i[0]}]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {user_in_tri_i[1]}]
...
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports {user_in_tri_i[2]}]
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports {user_in_tri_i[3]}]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports {user_in_tri_i[4]}]
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports {user_in_tri_i[5]}]
...
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports out_pwm]
