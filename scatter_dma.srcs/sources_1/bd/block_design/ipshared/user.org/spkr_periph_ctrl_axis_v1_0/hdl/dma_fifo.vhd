----------------------------------------------------------------------------------
-- Purpose: The buffer incoming samples.
-- Author: Not Andrew Powell! This module was taken from ADI's AXI I2S core ( called
-- "axi_i2s_adi_1.0" ), which I originally found in the Digilent base design project
-- associated with the Zybo. The author is likely ADI.
----------------------------------------------------------------------------------
