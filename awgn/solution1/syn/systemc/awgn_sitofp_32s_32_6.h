...
#ifndef __awgn_sitofp_32s_32_6__HH__
#define __awgn_sitofp_32s_32_6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(awgn_sitofp_32s_32_6) {
    ...
    SC_CTOR(awgn_sitofp_32s_32_6):  ACMP_sitofp_U ("ACMP_sitofp_U") {
